"""
AD9833 carrier on 144.800 MHz for ionospheric reflection testing.
No modulation, no AX.25 — just turn on/off the sine wave + PTT.
"""
import spidev
import RPi.GPIO as GPIO
from config import AD9833_SPI_BUS, AD9833_SPI_CS, AD9833_APRS_FREQ
...
class AprsBeacon:
    ...
    def _program_freq(self):
        fw = round(AD9833_APRS_FREQ * (1 << 28) / _MCLK) & 0x0FFFFFFF
